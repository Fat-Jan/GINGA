...
BASELINE_COMMANDS: list[list[str]] = [
    ...
    ["python3", "scripts/run_real_llm_harness.py", "--dry-run"],
    ["python3", "scripts/validate_multi_agent_harness.py"],
    [
        "python3",
        "scripts/validate_stage_closeout.py",
        "--commit-message",
        "v2.5 stage closeout harness: update template and validator; verification: verify_all baseline; residual risk: live commit and push still require operator review",
    ],
