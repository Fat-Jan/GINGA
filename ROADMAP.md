...
| **v1.9 / Story Truth Template** | 从原料整理小说真值模板，再用拆书产物、题材系列和长篇 drift 证据做缺口校验 | 🟢 v1.9-1 done；🟢 v1.9-2 done；🟢 v1.9-3 done；v1.9-4/5 planned | 已完成 source audit、只读 schema / validator 与 `StateIO` 项目/题材契约窄切片；下一步构建 `workspace.CHAPTER_INPUT_BUNDLE` |
