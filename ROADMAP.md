...
| **v1.9 / Story Truth Template** | 从原料整理小说真值模板，再用拆书产物、题材系列和长篇 drift 证据做缺口校验 | 🟢 v1.9-1 done；🟢 v1.9-2 done；v1.9-3/4/5 planned | 已完成 source audit 与只读 schema / validator；下一步做 `StateIO` 项目/题材契约窄切片，不得把 candidate / report / 污染路径直接写入 truth |
