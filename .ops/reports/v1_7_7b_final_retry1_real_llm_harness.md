...
- generated_at: `2026-05-17T00:55:55+00:00`
- profile: `longform-small-batch`
- dry_run: `False`
- passed: `False`
- real_llm_executed: `True`
- endpoint: `久久`
- book_id: `v1-7-7b-style-warn-final-retry1`
...
- state_root: `.ops/real_llm_harness/v1-7-7b-final-retry1-state`
- json_output: `.ops/validation/v1_7_7b_final_retry1_real_llm_harness.json`
- report_output: `.ops/reports/v1_7_7b_final_retry1_real_llm_harness.md`
- review_output_root: `.ops/reviews`

## Postflight

- status: `PASS`
- generation_summary: `{'requested_chapters': 4, 'completed_chapters': 4, 'drift_status': 'stable', 'failed_chapter': None, 'failure_reason': '', 'failed_batches': [], 'short_chapters': [], 'missing_foreshadow_chapters': [2, 3]}`

## Review Gate

- status: `blocked`
- report: `.ops/reviews/v1-7-7b-style-warn-final-retry1/v2-3-real-llm-review-gate/review_report.json`
- issue_count: `7`
- hard_gate_blocks_next_batch: `True`
- warning `review_hard_gate_blocks_next_batch`: block_reasons=['missing_foreshadow_marker']
