...
- generated_at: `2026-05-16T08:34:58+00:00`
- profile: `longform-small-batch`
- dry_run: `False`
- passed: `False`
- real_llm_executed: `True`
- endpoint: `久久`
- book_id: `v1-7-6-body-floor-single-ch1`
...
- state_root: `.ops/real_llm_harness/v1-7-6-body-floor-single-ch1-state`
- json_output: `.ops/validation/v1_7_6_body_floor_single_ch1_real_llm_harness.json`
- report_output: `.ops/reports/v1_7_6_body_floor_single_ch1_real_llm_harness.md`
- review_output_root: `.ops/reviews`

## Postflight

- status: `FAIL`
- generation_summary: `{'requested_chapters': 1, 'completed_chapters': 0, 'drift_status': 'stable', 'failed_chapter': 1, 'failure_reason': 'RuntimeError: chapter 1 failed quality gate after repair: short_chapter body_chinese_chars=2751 < 3600', 'failed_batches': [1], 'short_chapters': [], 'missing_foreshadow_chapters': []}`

## Review Gate

- status: `PASS`
- report: `.ops/reviews/v1-7-6-body-floor-single-ch1/v2-3-real-llm-review-gate/review_report.json`
- issue_count: `0`
