...
- generated_at: `2026-05-17T02:14:00+00:00`
...
- state_root: `.ops/real_llm_harness/v1-7-7b-marker-rerun2-state`
- json_output: `.ops/validation/v1_7_7b_marker_rerun2_real_llm_harness.json`
- report_output: `.ops/reports/v1_7_7b_marker_rerun2_real_llm_harness.md`
- review_output_root: `.ops/reviews`

## Postflight

- status: `FAIL`
- generation_summary: `{'requested_chapters': 4, 'completed_chapters': 2, 'drift_status': 'stable', 'failed_chapter': 3, 'failure_reason': 'RuntimeError: chapter 3 failed quality gate after repair: opening_loop_risk score=3; style_warn generic_emotion=1', 'failed_batches': [1], 'short_chapters': [], 'missing_foreshadow_chapters': []}`

## Review Gate

- status: `PASS`
- report: `.ops/reviews/v1-7-7b-marker-rerun2/v2-3-real-llm-review-gate/review_report.json`
- issue_count: `1`
