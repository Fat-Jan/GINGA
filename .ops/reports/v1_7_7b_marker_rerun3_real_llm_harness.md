...
- generated_at: `2026-05-17T02:32:26+00:00`
- profile: `longform-small-batch`
- dry_run: `False`
- passed: `True`
- real_llm_executed: `True`
- endpoint: `久久`
- book_id: `v1-7-7b-marker-rerun3`
...
- state_root: `.ops/real_llm_harness/v1-7-7b-marker-rerun3-state`
- json_output: `.ops/validation/v1_7_7b_marker_rerun3_real_llm_harness.json`
- report_output: `.ops/reports/v1_7_7b_marker_rerun3_real_llm_harness.md`
- review_output_root: `.ops/reviews`

## Postflight

- status: `PASS`
- generation_summary: `{'requested_chapters': 4, 'completed_chapters': 4, 'drift_status': 'needs_review', 'failed_chapter': None, 'failure_reason': '', 'failed_batches': [], 'short_chapters': [], 'missing_foreshadow_chapters': []}`

## Review Gate

- status: `PASS`
- report: `.ops/reviews/v1-7-7b-marker-rerun3/v2-3-real-llm-review-gate/review_report.json`
- issue_count: `9`
