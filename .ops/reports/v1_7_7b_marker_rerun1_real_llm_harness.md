...
- generated_at: `2026-05-17T01:55:51+00:00`
- profile: `longform-small-batch`
- dry_run: `False`
- passed: `False`
- real_llm_executed: `True`
- endpoint: `久久`
- book_id: `v1-7-7b-marker-rerun1`
...
- state_root: `.ops/real_llm_harness/v1-7-7b-marker-rerun1-state`
- json_output: `.ops/validation/v1_7_7b_marker_rerun1_real_llm_harness.json`
- report_output: `.ops/reports/v1_7_7b_marker_rerun1_real_llm_harness.md`
- review_output_root: `.ops/reviews`

## Postflight

- status: `FAIL`
- generation_summary: `{'requested_chapters': 4, 'completed_chapters': 2, 'drift_status': 'stable', 'failed_chapter': 1, 'failure_reason': 'RuntimeError: chapter 3 failed quality gate after repair: short_chapter body_chinese_chars=3197 < 3500; style_warn cliche_metaphor=1', 'failed_batches': [1], 'short_chapters': [], 'missing_foreshadow_chapters': []}`

## Review Gate

- status: `PASS`
- report: `.ops/reviews/v1-7-7b-marker-rerun1/v2-3-real-llm-review-gate/review_report.json`
- issue_count: `1`
