...
- generated_at: `2026-05-16T09:42:31+00:00`
- profile: `longform-small-batch`
- dry_run: `False`
- passed: `False`
- real_llm_executed: `True`
- endpoint: `久久`
- book_id: `v1-7-6-stylegate-final4`
...
- state_root: `.ops/real_llm_harness/v1-7-6-stylegate-final4-state`
- json_output: `.ops/validation/v1_7_6_stylegate_final4_real_llm_harness.json`
- report_output: `.ops/reports/v1_7_6_stylegate_final4_real_llm_harness.md`
- review_output_root: `.ops/reviews`

## Postflight

- status: `FAIL`
- generation_summary: `{'requested_chapters': 4, 'completed_chapters': 0, 'drift_status': 'stable', 'failed_chapter': 1, 'failure_reason': 'RuntimeError: chapter 1 failed quality gate after repair: style_warn abrupt_transition=2, cliche_metaphor=1', 'failed_batches': [1], 'short_chapters': [], 'missing_foreshadow_chapters': []}`
